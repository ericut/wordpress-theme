            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-white">
                    <p>
                        ...
                        <?php include($wp_theme_logic . "/src/paginas/mautic/cssforms.php"); ?>

                        <?php include($wp_theme_logic . "/src/paginas/mautic/sejacliente.php"); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-white">
                    ...
                    <?php include($wp_theme_logic . "/src/paginas/mautic/sejacanal.php"); ?>
